    ...
    , colorDialog(0)
{
    ...
    connect(player, SIGNAL(error(QMediaPlayer::Error)), this, SLOT(displayError()));
    ...
    listModel->setPlaylist(playlist);


    playlistView = new QListView(this);
    playlistView->setModel(listModel);
    playlistView->setCurrentIndex(listModel->index(playlist->currentIndex(), 0));
    ...
    connect(colorButton, SIGNAL(clicked()), this, SLOT(showColorD()));
    ...
    if (!isPlayerAvailable()) {
        QMessageBox::warning(this, tr("Service not available"),
                             tr("Please check the media service plugins are installed."));
...
{
    playlistView->setCurrentIndex(listModel->index(currentItem, 0));
}
